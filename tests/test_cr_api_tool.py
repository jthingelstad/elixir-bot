...
class TestExecuteCrApiDispatch:
    ...
    def test_leaderboard_requires_id_not_tag(self, execute_cr_api):
        ...
        with patch("cr_api.get_leaderboard", return_value=payload) as mock_fetch:
            result = execute_cr_api(
                {"aspect": "leaderboard", "leaderboard_id": 170000019, "limit": 10}
            )
...
class TestFilters:
    ...
    def test_player_battles_filter_respects_limit(self, execute_cr_api):
        battles = [
            {
                "type": "PvP",
                "battleTime": f"2026040{i:02d}T000000.000Z",
            ...
            "items": [
                {
                    ...
                    "standings": [
                        {
                            "rank": 2,
                            "clan": {"tag": "#PYLQ2", "name": "them", "fame": 3000},
                        },
