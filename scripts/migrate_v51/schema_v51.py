...
EXPECTED_TABLE_COUNT = 62  # +member_outreach (V6); -editor_verdicts (V8); -recognition_ledger (V9); -elixir_improvement_suggestions (V10); -memory_log (V12); -system_signals (V13); -4 dead tables (V14); tournament_events added V11 then dropped V15; -tournament_battles (V19, folded into battle_events)
