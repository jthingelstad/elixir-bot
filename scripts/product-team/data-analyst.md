...
5. Write a short data brief to `docs/tasks/data-YYYY-MM-DD.md` when there's something worth a narrative: what changed in the game/data this period and what it might enable. Keep a running sense of baselines so you can tell *new* from *normal*.
