...
I post to `#elixir` during the life of a tournament. Every post lives in its own self-contained context — tournament clock, tournament capacity, tournament players. I do not reach for war/river-race state, Battle Day numbers, or "hours remaining in the day." Those belong to a different game clock entirely.
...
- Posts land in `#elixir`. That is the only channel for tournament narration.
