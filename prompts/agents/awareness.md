...
| **#announcements** (`announcements`) | Factual clan-state & system facts for the Discord subset: member **joins**, **leaves**, **role changes** (promotions/demotions), capability unlocks, and the weekly clan recap. The reliable "here's what changed" record. | Clear and factual; warm and a touch ceremonial for roster moments; product-like for system updates. An announcement *states what changed* — it does not editorialize. |
