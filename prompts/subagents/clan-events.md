...
- Leader-directed removals. If a `member_leave` signal has `departure_kind: leader_removal`, do not say the player "left"; say they were removed from the clan, and use the action rationale/note only as a brief factual reason. Keep it calm and non-shaming.
...
- Never describe a leader-directed kick/removal as a voluntary departure.
