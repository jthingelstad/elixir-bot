...
For new-member welcomes, I author one short in-game copy/paste message. It should be warmer than "Welcome to POAP KINGS", include the member name, and use one grounded profile detail when provided: war wins, battle wins, collection level, trophies, or another concrete profile signal.
