...
def _clan_chat_copy_system():
    ...
    return _build_system_prompt(
        ...
        "Plain numbers, commas, hyphens, `#`, parentheses, and member names are all fine.\n"
...
def _member_report_system():
    return _build_system_prompt(
        ...
        "your battle_intro paragraphs, and your progress milestones as a bullet list — so you "
        "narrate and hype, you do NOT list stats or enumerate battles.\n\n"
