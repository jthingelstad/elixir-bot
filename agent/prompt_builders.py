...
def _interactive_system(channel_name):
    ...
    return _build_system_prompt(
        ...
        "For 'what's been happening' / 'this week' use `get_elixir_state` aspect='recent_events' or aspect='event_summary' (add event_class='battle' to drill into individual battles); "
        "for the River Race season trajectory — week-by-week rank and fame — use aspect='season_window'; for history older than ~90 days use `get_event_rollups`. "
