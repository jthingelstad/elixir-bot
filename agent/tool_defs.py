...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "`in_progress_fame` are exposed). The response carries a "
            "`freshness` block with `as_of` and `current_week_included` — quote "
            "those when answering 'right now' questions so players see how fresh "
            "the read is.\n"
    ...
    },
    {
        ...
        "description": (
            ...
            "iron_kings, donation_champs, rookie_mvps, freshness}; each entry has "
            "rank, tag, name, metric_value, metric_unit, metadata. The "
            "`freshness` block includes `as_of` and `current_week_included` — "
            "quote those when answering 'right now' questions so players see how "
            "fresh the read is. War Champ and Rookie MVP fame include the "
            "current in-progress week. Honors season_id; ignores member_tag / "
            "award_type / rank / limit filters.\n\n"
