...
TOOLS = [
    # ── BATTLE INTELLIGENCE (computed, no model) ───────────────────────────
    {
        ...
        "description": (
            ...
            "their record against each), and each deck carries 'matchup_fit' against that "
            "field. Use it — a deck is good FOR SOMEONE, and 'you lose to bait more than "
            "any other matchup, and this list handles it better' is the reason a "
            "recommendation lands. 0.500 is even; these are matchup reads, not predictions "
            "of how they personally will do.\n\n"
