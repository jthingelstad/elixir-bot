...
def register_tournament(tournament_tag: str, api_data: dict, conn=None):
...
def poll_tournament(tournament_tag: str, api_data: dict, conn=None):
...
def store_tournament_battle(tournament_id: int, battle: dict, conn=None):
...
def finalize_tournament(tournament_tag: str, api_data: dict, conn=None):
...
def get_active_tournament(conn=None):
...
def get_tournament_by_tag(tournament_tag: str, conn=None):
...
def get_tournament_participants(tournament_id: int, conn=None):
...
def get_tournament_battles(tournament_id: int, conn=None):
...
def get_recent_tournaments_for_recap(days: int = 7, conn=None):
...
def get_tournament_card_stats(tournament_id: int, conn=None):
...
def build_tournament_recap_context(tournament_tag: str, conn=None):
