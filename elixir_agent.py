...
EDITORIAL_SYSTEM = (
    ...
    "POAP KINGS website. This appears as a speech bubble from you on the home page. "
    "It should reflect what's happening in the clan right now — war activity, trophy "
    "pushes, donation streaks, roster changes, or just hype the crew up.\n\n"
    "Guidelines:\n"
