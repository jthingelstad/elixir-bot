...
- Clan management: `leader_action_recommendations`, `revisits`. The legacy `decision_cases` table is inert after #216 and remains only until the post-deploy contract migration removes it.
