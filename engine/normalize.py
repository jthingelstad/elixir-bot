...
~/Projects/clash-royale/cr-agent-api-docs/ or the live incident that taught it; (2) normalization
...
# --- war-week structure (~/Projects/clash-royale/cr-agent-api-docs/models/clans.md; verified against
...
def card_display_level(level, max_level) -> int | None:
    ...
    level is `level + (16 - maxLevel)` (~/Projects/clash-royale/cr-agent-api-docs/cards.md — a max-level
...
LEGACY_POL_LEAGUES = {  # pre-rework Path of Legends scale (~/Projects/clash-royale/cr-agent-api-docs)
    1: "Challenger I",
    2: "Challenger II",
    3: "Challenger III",
    4: "Master I",
...
def pol_rank_improved(old_rank, new_rank) -> bool:
    ...
    ~/Projects/clash-royale/cr-agent-api-docs/leaderboards.md. Newly attained (old None) counts."""
